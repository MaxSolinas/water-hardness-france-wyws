(function() {
    ...
    const css = `
        ...
        .kw-fr-cta-button { display: none; margin-top: 15px; background: #0054A4; color: white; text-decoration: none; padding: 14px 30px; border-radius: 6px; font-weight: bold; transition: 0.3s; text-transform: uppercase; letter-spacing: 0.5px; }
    ...
    const htmlTemplate = `
        <div id="kinetico-fr-widget-container">
            ...
            <div class="kw-fr-search-area">
                ...
                <div id="kw-loader-fr" class="kw-fr-loader">Recherche en cours...</div>
            ...
            <div id="kw-result-fr" class="kw-fr-result-panel" style="display:none;">
                ...
                <div class="kw-fr-message-box">
                    ...
                    <a href="${CONFIG.quoteLink}" id="kw-cta-btn-fr" class="kw-fr-cta-button">AMÉLIOREZ VOTRE WATER SCORE AUJOURD'HUI !</a>
                </div>
            </div>
            <div class="kw-fr-footer-block">
                ...
                <span class="kw-fr-source-data">Données : Hub'Eau / Ministère de la Santé (API Temps Réel)</span>
            </div>
        </div>
    `;
        ...
        async function startAnalysis(insee, name) {
            ...
            try {
                ...
                if (data) {
                    ...
                    errorMsg.innerHTML = "Pas de données récentes pour <strong>" + name + "</strong>.";
